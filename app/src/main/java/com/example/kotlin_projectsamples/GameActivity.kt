...
//        supportActionBar!!.title = "Addition"
        ...
        buttonOk.setOnClickListener {
            ...
            if (input == "") {
                Toast.makeText(applicationContext, "Please write your answer!", Toast.LENGTH_LONG)
                    .show()
            } else {
                pauseTimer()
                ...
                if (userAnswer == correctAnswer) {
                    userScore += 10
                    textQuestion.text = "Congratulation!! You are correct!"
                    textScore.text = userScore.toString()
                } else {
                    userLife--
                    textQuestion.text = "Sorry!! You are wrong ..."
